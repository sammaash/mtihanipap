...
// var dotpos = x.lastIndexOf(".");if (atpos<1 || dotpossi<atpos+2 || dotpos+2>=x.length) {alert("Not a valid e-mail address.");return false;}var a = document.forms["form"]["password"].value;if(a == null || a == ""){alert("Password must be filled out");return false;}if(a.length<5 || a.length>25){alert("Passwords must be 5 to 25 characters long.");return false;}
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="email" name="uname" placeholder="Enter your email-id" class="form-control input-md" type="email">
...
<!-- sign in form begins -->  
  ...
  <form class="form-horizontal"  name="form" action="login.php" onSubmit="return validateForm()" method="POST">

  <!-- <form class="form-horizontal"  name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST"> -->
<fieldset>
<div class="form-group">

<label for="texti">STUDENT LOGIN</label> 
